...
$BackupDirs = 
    @(
        ...
        @("$nasDr\Student Application Site","History_Student Application Site","Student Application Site Backup History"),
        ...
        @("$vmDr\Sync2","History_VM-Sync2","Sync2 Backup History"),
